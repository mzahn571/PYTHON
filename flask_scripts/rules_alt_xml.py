...
top = '_' * 100
hostname = 'localhost'
url = "http://%s:5000/xml/pan/security/new_rules"% hostname
username = 'student'
password = 'student'
...
print top
print('{:<22s}{:>17s}{:>17s}{:>22s}{:>17s}'.format('Rule Name', 'Source Zone', 'Source Subnet', 'Dest Zone', 'Dest'))
print dash
data = get_data.text
...
for i in soup.find_all('entry'):
	...
	print('{:<20s}{:>15s}{:>20s}{:>20s}{:>20s}'.format(rule_name, source_zone, source_cidr, dest_zone,dest_cidr ))
	print dash
