...
#THIS PURPOSE of THIS SCRIPT IS to TEST CISCO BACKUP CONNECTION 
#WITH THE USE OF RSA - KEYGEN being applied to a Cisco Device
...
def bk_cisco(NEW_PATH, HOST, COMMAND, COMMAND):
	"""Define Operation to backup the configuration files cisco"""
	f = open(NEW_PATH, "w")
...
bk_operation(NEW_PATH2, IPSEC02, COMMAND2)
