...
#computername = "devdsk-bkup-"
filename = "devdsk-bkup-"
date = datetime.now().strftime("%Y-%m-%d")
username = os.environ.get('USER')
#local_path = "/local/home/"

homedir = "/local/home/mzahn/tmp"
...
logging.basicConfig(
    #logfilename="homedir/filename" + date + "-bkup.log", format=log_format)
    #filename="home/mzahn/tmp/test.log", format=log_format)
    filename = filename + date + log_extension, format=log_format)
